...
export default function About() {
  return (
    <div className="pt-16 md:pt-20">
      {/* Hero Section */}
      <section className="py-12 md:py-24 gradient-bg relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="animate-fade-in">
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 md:mb-6 text-white">Innovating Digital Excellence</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-16 items-center">
            ...
            <div className="animate-slide-in-left">
              <div className="inline-flex items-center px-3 py-1 md:px-4 md:py-2 bg-purple-100 rounded-full mb-4 md:mb-6">
                <Target className="w-3 h-3 md:w-4 md:h-4 text-purple-600 mr-1 md:mr-2" />
                <span className="text-xs md:text-sm font-medium text-purple-700">Our Mission</span>
              </div>
              <h2 className="text-3xl md:text-4xl font-bold mb-4 md:mb-6 gradient-text">Empowering Digital Transformation</h2>
              <p className="text-base md:text-lg text-slate-600 mb-4 md:mb-6 leading-relaxed">
                ...
                combine the power of modern web technologies with artificial intelligence.
              </p>
              ...
              <div className="space-y-3 md:space-y-4">
                {[
                  ...
                  <div key={item} className="flex items-start">
                    <div className="w-5 h-5 md:w-6 md:h-6 gradient-bg rounded-full flex items-center justify-center mr-2 md:mr-3 mt-0.5">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12 md:mb-16 animate-slide-up">
            <div className="inline-flex items-center px-3 py-1 md:px-4 md:py-2 bg-green-100 rounded-full mb-4 md:mb-6">
              ...
              <span className="text-xs md:text-sm font-medium text-green-700">Our Team</span>
            </div>
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 md:mb-6 gradient-text">Meet Our Team</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 max-w-4xl md:max-w-5xl mx-auto">
            {/* Ali Hamza */}
            <div className="bg-gradient-to-br from-purple-50 to-pink-50 p-6 md:p-8 rounded-2xl md:rounded-3xl border border-purple-100 hover:shadow-lg md:hover:shadow-2xl transition-all duration-300 transform hover:scale-[1.02] md:hover:scale-105 card-hover animate-slide-up">
              <div className="text-center mb-4 md:mb-6">
                <div className="w-16 h-16 md:w-24 md:h-24 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full flex items-center justify-center mx-auto mb-3 md:mb-4">
                ...
                <div className="inline-flex items-center px-2 py-0.5 md:px-3 md:py-1 bg-purple-100 rounded-full mb-1 md:mb-2">
                  <span className="text-xs md:text-sm font-bold text-purple-700">FOUNDER & CHIEF OPERATOR</span>
                </div>
                <p className="text-sm md:text-base text-purple-600 font-semibold mb-1">Business Development & Marketing Head</p>
            ...
            {/* Najaf Ali */}
            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 p-6 md:p-8 rounded-2xl md:rounded-3xl border border-blue-100 hover:shadow-lg md:hover:shadow-2xl transition-all duration-300 transform hover:scale-[1.02] md:hover:scale-105 card-hover animate-slide-up">
              <div className="text-center mb-4 md:mb-6">
                <div className="w-16 h-16 md:w-24 md:h-24 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-full flex items-center justify-center mx-auto mb-3 md:mb-4">
          ...
          {/* Team Stats */}
          <div className="mt-12 md:mt-16 grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 max-w-3xl md:max-w-4xl mx-auto">
            {[
              ...
              <div key={stat.label} className="text-center">
                <div className={`text-xl md:text-2xl lg:text-3xl font-bold mb-1 md:mb-2 ${stat.color}`}>{stat.value}</div>
      ...
      <section className="py-12 md:py-24 bg-gradient-to-br from-slate-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 md:mb-16 animate-slide-up">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 md:mb-6 gradient-text">Looking Forward</h2>
            <div className="w-16 md:w-24 h-1 gradient-bg mx-auto rounded-full" />
          </div>
