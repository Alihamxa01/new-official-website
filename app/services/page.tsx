...
From concept to launch, we deliver powerful, scalable AI integration services that help you grow, engage, and lead in your industry.            </p>
      ...
      <section className="py-8 md:py-12 lg:py-20 bg-gradient-to-br from-slate-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Services in 3-Column Grid */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8 mb-8 md:mb-12 lg:mb-16">
            {services.slice(0, 3).map((service, index) => (
              <div
                key={index}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 lg:gap-8">
            {services.slice(3, 7).map((service, index) => (
              <div
                key={index + 2}
                className={`bg-gradient-to-br ${service.bgGradient} p-4 md:p-6 lg:p-8 rounded-xl md:rounded-2xl lg:rounded-3xl border border-slate-200 hover:shadow-md md:hover:shadow-lg lg:hover:shadow-xl transition-all duration-500 transform hover:scale-[1.02] card-hover animate-slide-up`}
              >
                <div
                  className={`w-10 h-10 md:w-12 md:h-12 lg:w-16 lg:h-16 bg-gradient-to-r ${service.gradient} rounded-lg md:rounded-xl lg:rounded-2xl flex items-center justify-center text-white mb-3 md:mb-4 lg:mb-6`}
                >
